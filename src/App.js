    ...
    return (<div>
      ...
      <main className="row d-flex justify-content-center m-5">
        ...
        {this.state.elements.map(e =>
          <Image onClick={() => this.clickedCard(e)} key={e} className="align-self-center" src={process.env.PUBLIC_URL+'/assets/images/' + e + '.png'} className="m-2 image-card" width={170} height={170} thumbnail />
        )}
